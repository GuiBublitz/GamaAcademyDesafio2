...
console.log("Olá, avaliador(a)! Criamos uma function que se chama 'all', ela mostra todas as respostas de uma vez!");
...
function exercicio9(){
    ...
    console.log("Produto de estoque menos valioso é o "+ ProdutoMenosValioso.descricao + " cujo preço da unidade é de " + ProdutoMenosValioso.preco.toLocaleString('pt-br',{style: 'currency', currency: 'BRL'}) +
